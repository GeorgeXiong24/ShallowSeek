...
class ColorBlocksApp:
    def __init__(self, root):
        ...
        self.output_text = tk.Text(output_frame, height=25, width=60, bg='#383A40', fg='white', insertbackground='white', state='disabled', font=("TkDefaultFont", 12))
        ...
        send_button = ttk.Button(input_frame, text="Send", style='Dark.TButton', command=self.process_input)
        ...
        button_style.configure('Dark.TButton', font=("TkDefaultFont", 11))
    ...
    def show_attach_message(self):
        ...
        # Add message label
        message_label = ttk.Label(dialog, text="Unable to attach file", style='Dark.TLabel', font=("TkDefaultFont", 12))
    ...
    def process_input(self):
        ...
        if user_input:
            ...
            try:
                ...
                # Add assistant response with left alignment and styling
                self.output_text.insert(tk.END, '\n')
